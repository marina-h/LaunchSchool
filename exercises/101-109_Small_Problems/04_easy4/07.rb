...
# method.  Write a method that takes a String of digits, and returns the
# appropriate number as an integer. You may not use any of the methods mentioned
# above.  For now, do not worry about leading + or - signs, nor should you worry
# about invalid characters; assume all characters will be numeric.  You may not
# use any of the standard conversion methods available in Ruby, such as
